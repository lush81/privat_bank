 ...
 */
define(['angular', 'angular-mocks', 'js/app/filters'], function () {
    describe('filters', function () {
        ...
        it("should order By order field", function () {
            var items = [{"id": "REISSUE_1", "order": 0}, {"id": "REISSUE_3", "order": 3}, {
                "id": "REISSUE_2",
                "order": 2
            }];
            var expected = [{"id": "REISSUE_1", "order": 0}, {"id": "REISSUE_2", "order": 2}, {
                "id": "REISSUE_3",
                "order": 3
            }];
